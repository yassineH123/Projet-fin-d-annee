  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: currentColors.background }]} edges={['top', 'left', 'right']}>
      ...
      <View style={styles.container}>
        <Card>
          <TouchableOpacity style={styles.row} onPress={() => { /* TODO: data export */ }}>
          ...
          <TouchableOpacity style={styles.row} onPress={() => { /* TODO: delete account */ }}>
            <Typography variant="bodySemibold">Supprimer mon compte</Typography>
            <Feather name="chevron-right" size={20} color={currentColors.textSecondary} />
          </TouchableOpacity>
        </Card>
      </View>
